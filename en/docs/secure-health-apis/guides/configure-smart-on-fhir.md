---
sidebar_position: 1
title: "Configuring SMART App Launch for a Patient User"
...
## Prerequisites
1. Install the latest WSO2 API Manager version and install the [WSO2 Open Healthcare Accelerator](../../install-and-setup/manual.md).
...
2. After Self Sign up, log into Carbon Console. `https://localhost:9443/carbon`
3. Go to Claim section and select 'List', and select `http://wso2.org/claims` and select 'Patient ID' from the list. 
...
## Step 4 - Execute Authorization Code grant flow and retrieve the Patient ID. 
...
2. Once redirected to the Authentication Portal sign in with the user you created at step 2 (username: johndoe). 
