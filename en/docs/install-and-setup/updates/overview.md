...
In case you are faced with an issue in your environment, if this has been fixed in an update already and you have missed a recent update,
it is possible that the issue is already fixed in a more recent update.

Whenever WSO2 releases a security update, we inform our customers at our earliest. 
WSO2 always recommends applying security updates sooner whenever we release a security update. This will ensure your production environment is secure.
