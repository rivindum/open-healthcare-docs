...
description: This service provides implementation of FHIR Metadata API.
---
...
2. Configure and Deploy
   ...
   - On deployment, configurables mentioned in [Configurations/Configs](#configurations) need to be configured in the Choreo configurable editor.
