---
sidebar_position: 2
title: "EHR/EMR Connector Support"
description: WSO2’s solution offers out of the box connectors for EPIC, Cerner, Athena Health EMRs and is capable of generating connectors automatically to any FHIR based or Open API specification based EHR/EMR system.
---
...
![connector_generation](/assets/img/learn/connector/connector.png)
...
![search_params](/assets/img/learn/connector/searchparams.png)
...
![range](/assets/img/learn/connector/range.png)

![value](/assets/img/learn/connector/value.png)
