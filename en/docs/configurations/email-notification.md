...
description: This page documents the configurations that should be added in order to enable email notifications to the 'deployment.toml' file under <code>&lt;OH_APIM_HOME&gt;/repository/conf</code>.
---
